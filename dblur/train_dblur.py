...
from models import *
from data_blur import Provider, SRBenchmark
...
def parse_args():
    ...
    parser.add_argument("--train-dir", type=str, default='/home/zlai/dataset/GOPRO_LARGE',
                        help="Training images")
    parser.add_argument("--val-dir", type=str, default='/home/zlai/dataset',
    ...
    parser.add_argument('--msb', type=str, default='sdy', choices=['p', 'hl', 'hs', 'hd', 'sdy', 'hdv', 'hdb', 'hdbv', 'hdbl'])
    parser.add_argument('--lsb', type=str, default='sdy', choices=['p', 'hl', 'hd', 'hs', 'sdy', 'hdv', 'hdb', 'hdbv', 'hdbl'])
...
if __name__ == "__main__":
    ...
    if args.start_iter > 0:
        for stage in range(n_stages):
            ...
            models[stage].load_state_dict(lm, strict=True)#0
            ...
            with torch.no_grad():
                ...
                for j in range(len(valid_datasets)):
                    ...
                    for k in range(len(files)):
                        key = valid_datasets[j] + '_' + files[k][-27:-23]+files[k][-22:-20]+files[k][-19:-17]+files[k][-10:-4]

                        img_gt = valid_loader.ims[key] # (512, 512, 3) range [0, 255]
                        input_im = valid_loader.ims[key + '_lq'] # (128, 128, 3) range [0, 255]
