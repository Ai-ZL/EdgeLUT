...
from data_blur import SRBenchmark
...
def parse_args():
    ...
    parser.add_argument("--test-dir", type=str, default='/home/zlai/dataset',
                        help="Testing images")
    ...
    with torch.no_grad():
        ...
        for j in range(len(test_datasets)):
            ...
            for k in range(len(files)):
                ...
                input_im = test_loader.ims[key + '_lq'] # (128, 128, 3) range [0, 255]
