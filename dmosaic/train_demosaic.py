...
from models import *
from data_demosaic import Provider, SRBenchmark
from utils import PSNR, _rgb2ycbcr, seed_everything, bPSNR
...
def parse_args():
    ...
    parser.add_argument("--train-dir", type=str, default='/home/zlai/dataset/DIV2K',
                        help="Training images")
    parser.add_argument("--val-dir", type=str, default='/home/zlai/dataset/benchmark',
            ...
            with torch.no_grad():
                ...
                for j in range(len(valid_datasets)):
                    ...
                    for k in range(len(files)):
                        ...
                        input_im = valid_loader.ims[key + 'n%d' % sr_scale] # (128, 128, 3) range [0, 255]
                        ...
                        # PSNR on Y channel
                        psnrs.append(bPSNR(img_gt, image_out, sr_scale))
