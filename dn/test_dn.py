...
from data_noise import SRBenchmark
...
if __name__ == "__main__":
    ...
    test_datasets = ['Set5', 'Set14', 'B100', 'Urban100', 'Manga109','CBSD68']
    ...
    with torch.no_grad():
        ...
        for j in range(len(test_datasets)):
            ...
            for k in range(len(files)):
                ...
                input_im = test_loader.ims[key + 'n%d' % args.noise] # (128, 128, 3) range [0, 255]
