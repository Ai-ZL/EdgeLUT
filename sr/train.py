...
def parse_args():
    ...
    parser.add_argument("--train-dir", type=str, default='/home/zlai/DIV2K',
                        help="Training images")
    parser.add_argument("--val-dir", type=str, default='/home/zlai/benchmark',
