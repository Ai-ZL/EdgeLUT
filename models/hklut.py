...
from .luts import HDLUT, HDVLUT, HDBLUT, HDBVLUT, HLLUT, HSLUT, HDBLLUT
...
class HKLUT(nn.Module): 
    def __init__(self, msb_weights, lsb_weights, msb='hdb', lsb='hdv', upscale=2):
        ...
        unit_dict = {'hd': HDLUT, 'hl': HLLUT, 'hs': HSLUT, 'hdv': HDVLUT, 'hdb': HDBLUT, 'hdbv': HDBVLUT, 'hdbl': HDBLLUT}
    ...
    def forward(self, img_lr):
        ...
        return torch.clamp(img_out, 0, 1), MSB_out, LSB_out
